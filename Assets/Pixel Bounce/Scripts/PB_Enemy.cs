...
public class PB_Enemy:MonoBehaviour{
	...
	public int _killPoint = 1;						// How many points this enemy is worth killing
	public int _alivePoint = -5;					// How many points is lost if this enemy gets past player
	...
	public void CheckBounds(){								// Check if enemy is in the game bounds
